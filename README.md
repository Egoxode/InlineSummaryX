...
**AI Disclaimer.** This fork was edited with an AI assistant. Read the code before you rely on it. Summaries the extension writes into chat are generated by whatever model you have selected in SillyTavern — they can be incomplete or wrong. Keep the originals attached to the summary if you may need the source text later.
